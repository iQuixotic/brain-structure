    ...
    render() {
        ...
        <div id={this.props.id} className={this.props.cn}>
            ...
            <Card id="note-input-crd">
                ...
                <input id="My Notes" defaultChecked={true} onClick={this.radioChangeHandler} type="radio" name="input" />
                <label className="lab" for="Notes">Notes</label>
               
                <input id="Research" onClick={this.radioChangeHandler} type="radio" name="input" />
                <label className="lab" for="Research">Research Studies</label>
                {
                    this.state.cardType ?

                        <textarea value={this.state.notesInput} name="linkInput" 
                        onChange={this.inputChangeHandler.bind(this)} className="input-field size" type="text" name="name"
                        rows="9" placeholder="...my notes here" /> :

                    <div>                        
                        <textarea value={this.state.linkInput} name="notesInput" 
                        onChange={this.inputChangeHandler.bind(this)} className="input-field marg1" type="text" name="name" 
                        rows="2" placeholder="...link" />

                        <textarea value={this.state.summaryInput} name="summaryInput" 
                        onChange={this.inputChangeHandler.bind(this)} className="input-field marg2" type="text" name="name" 
